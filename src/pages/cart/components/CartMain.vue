<template>
  <scroll-view class="viewport" scroll-y enable-back-to-top @scrolltolower="onScrolltolower">
    ...
    <template v-if="memberStore.profile">
      ...
      <view class="cart-list" v-if="showCartList">
        ...
        <uni-swipe-action>
          ...
          <uni-swipe-action-item v-for="item in cartList" :key="item.skuId" class="cart-swipe">
            ...
            <view class="goods">
              <!-- 选中状态 -->
              <checkbox @tap="onChangeSelected(item)" class="checkbox" :checked="item.selected" />
              <navigator
      ...
      >
        <checkbox @tap="onChangeSelectedAll" class="all" :checked="updatedIsSelectedAll"
          >全选</checkbox
        >
...
const updatedIsSelectedAll: ComputedRef<boolean | undefined> = isSelectedAll as ComputedRef<
  boolean | undefined
>
...
const gotoPayment = () => {
  ...
  // 跳转到结算页
  uni.navigateTo({ url: '/subpackage/create/create' })
}
</script>
